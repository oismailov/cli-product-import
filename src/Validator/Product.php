...
use App\Validator\Constraints\Float as FloatAssert;
...
class Product
{
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('normalPrice', new FloatAssert\ContainsFloat());

        $metadata->addPropertyConstraint('specialPrice', new FloatAssert\ContainsFloat());
